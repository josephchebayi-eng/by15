  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "lime-glass": {
          50: "rgba(132, 204, 22, 0.03)",
          100: "rgba(132, 204, 22, 0.05)",
          200: "rgba(132, 204, 22, 0.08)",
          300: "rgba(132, 204, 22, 0.12)",
          400: "rgba(132, 204, 22, 0.15)",
          500: "rgba(132, 204, 22, 0.2)",
          600: "rgba(132, 204, 22, 0.25)",
          700: "rgba(132, 204, 22, 0.3)",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
